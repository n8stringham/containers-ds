...
class NormalizedStr:
    ...
    *semantically*,
    ...
    def __add__(self, b):
        ...
        together.
        '''
        combined_str = self.text + unicodedata.normalize(self.normal_form,
                                                         str(b))
        combined_str_norm = unicodedata.normalize(self.normal_form,
                                                  combined_str)
        return NormalizedStr(combined_str_norm, self.normal_form)
